...
export interface ErrorDetail {
  /** Stable machine-readable classification supplied by the server. */
  code?: string
 ...
 *
 * When the server returns a structured error it includes `code`, `hint`, and
 * sometimes `raw` in the response body, which
