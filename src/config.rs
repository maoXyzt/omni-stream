...
/// Optional user-triggered video compatibility stream. Disabled by default
/// because video encoding is CPU-intensive and requires an external FFmpeg
/// binary with the libx264 and AAC encoders.
#[derive(Debug, Clone, Deserialize)]
#[serde(default)]
