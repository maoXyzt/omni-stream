...
This project is indexed by GitNexus as **omni-stream** (2947 symbols, 6730 relationships, 254 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/omni-stream/context` | Codebase overview, check index freshness |
| `gitnexus://repo/omni-stream/clusters` | All functional areas |
| `gitnexus://repo/omni-stream/processes` | All execution flows |
| `gitnexus://repo/omni-stream/process/{name}` | Step-by-step execution trace |
